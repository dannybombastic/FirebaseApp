...
public class FragmentComentarios extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        guardar =(Button)root.findViewById(R.id.guardar);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                coment.setCometario(comentario.getText().toString());
                coment.setUser(FirebaseActivity.USER_NAME);
                coment.setFoto(FirebaseActivity.USER_PIC);
                coment.setPara(mParam1);
                coment.setEstrellas((int)ratingBar.getRating());
                mYref.child("comentarios").push().setValue(coment);
