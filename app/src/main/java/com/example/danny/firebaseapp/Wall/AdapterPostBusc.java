...
abstract public class AdapterPostBusc<T,VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>  {

    private static final String TAG = "FirebaseRecyclerAdapter";

    public FirebaseArrayDesc mSnapshots;
    ...
    protected AdapterPostBusc(Class<T> modelClass,
                              @LayoutRes int modelLayout,
                              Class<VH> viewHolderClass,
                              FirebaseArrayDesc snapshots) {
        ...
        mSnapshots.setOnChangedListener(new FirebaseArrayDesc.OnChangedListener() {
            @Override
            ...
            public void onCancelled(DatabaseError databaseError) {
                AdapterPostBusc.this.onCancelled(databaseError);
            }

            @Override
            public void onDataChanged() {
                AdapterPostBusc.this.onDataChanged();
            }
        });
    }
     ...
     */
    public AdapterPostBusc(Class<T> modelClass,
                       int modelLayout,
                       Class<VH> viewHolderClass,
                       Query ref,FirebaseArrayDesc arg) {
