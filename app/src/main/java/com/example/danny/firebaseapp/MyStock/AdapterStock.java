...
public abstract class AdapterStock <T,VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>{


    private static final String TAG = "FirebaseRecyclerAdapter";

    public FireBaseArrayStock mSnapshots;
    ...
    AdapterStock(Class<T> modelClass,
                    @LayoutRes int modelLayout,
                    Class<VH> viewHolderClass,
                    FireBaseArrayStock snapshots) {
        ...
        mSnapshots.setOnChangedListener(new FireBaseArrayStock.OnChangedListener() {
            @Override
            ...
            public void onCancelled(DatabaseError databaseError) {
                AdapterStock.this.onCancelled(databaseError);
            }

            @Override
            public void onDataChanged() {
                AdapterStock.this.onDataChanged();
            }
        });
    }
     ...
     */
    public AdapterStock(Class<T> modelClass,
                           int modelLayout,
                           Class<VH> viewHolderClass,
                           Query ref, FireBaseArrayStock arg) {
