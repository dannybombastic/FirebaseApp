...
/**
 * Created by Vspc-PoisonRiver on 01/02/2017.
 */

public abstract class AdapterPost <T,VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>  {
    ...
    AdapterPost(Class<T> modelClass,
        ...
        mSnapshots.setOnChangedListener(new FirebaseArray.OnChangedListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                AdapterPost.this.onCancelled(databaseError);
            }

            @Override
            public void onDataChanged() {
                AdapterPost.this.onDataChanged();
            }
        });
    }
     ...
     */
    public AdapterPost(Class<T> modelClass,
                                   int modelLayout,
                                   Class<VH> viewHolderClass,
                                   Query ref) {
